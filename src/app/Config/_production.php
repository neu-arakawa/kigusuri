...
define('SITE_URL', 'http://www.kigusuri.com');
...
return array(
    ...
    'database' => array(
        ...
        'host'      => '127.0.0.1',
        'port'      => '3316',
        'database'  => 'kigusuri-com03',
        'username'  => 'kigusuri-com03',
        'password'  => 'xLRg9GT237Rf292a4MjwAXgdDTfs39',
        'charset'   => 'utf8',
    ...
    'mail' => array(
        ...
        'default' => array(
            ...
            'Return-path' => 'kigusuri@tochimoto.co.jp',
        ...
        'question_approval_request_for_admin' => array(
            'To' =>  array('info@kigusuri.com','support@kigusuri.com','kigusuri@tochimoto.co.jp')  
        ),
