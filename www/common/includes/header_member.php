...
<header class="member">
	<div class="header-inner fbox">
		...
		<nav id="gnav-wrap">
			<ul id="gnav">
				<li id="gnav-qa"><a href="/consultation/"><span class="icon-qa">漢方相談Q&amp;A</span></a></li>
				...
				<li id="gnav-biginer"><a href="/biginner/"><span class="icon-biginer">はじめての方へ</span></a></li>
			</ul>
	
			<div id="nav-user-wrap">
				<ul id="nav-user">
					<li><a href="sample" class="btn-form header-btn01">新規相談フォーム</a></li>
					<li><span class="user-name">はなこはなこはなこ<span>さん</span></span>
						<div class="user-menu-wrap">
							<ul class="user-menu">
								<li><a href="sample"><span>相談履歴</span></a></li>
