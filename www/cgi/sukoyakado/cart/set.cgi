...
# 代引手数料基準金額を10000円→5000円に変更
print "<TR BGCOLOR=FFF8DC><TD class=\"main2\">税込5,250円未満の場合</TD><TD class=\"main2\"><input type=text name=daibiki_0 value=$daibiki_0 size=5>円</TD></TR>\n";
print "<TR BGCOLOR=FFF8DC><TD class=\"main2\">税込5,250円以上<BR>10,500円未満の場合</TD><TD class=\"main2\"><input type=text name=daibiki_1 value=$daibiki_1 size=5>円</TD></TR>\n";
    print "<TR BGCOLOR=FFF8DC><TD class=\"main2\">10,500円以上<BR>100,000円未満の場合</TD><TD class=\"main2\"><input type=text name=daibiki_3 value=$daibiki_3 size=5>円</TD></TR>\n";
