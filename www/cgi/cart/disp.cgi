...
open HTML,">set/disp.html" || die "Could not open the file";
		...
		print HTML "<!--edit--><html><head><title>$MYDATA{'company'}　|　特定商取引に関する法律に基づく表\示</title></head><body bgcolor=\"white\"><center><!--/edit-->\n";

		print HTML "<table bgcolor=\"#333333\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\">\n";
		print HTML "<tr>\n";
		print HTML "<td>\n";
		...
		print HTML "<!--edit--></center>\n";
		print HTML "</body></html><!--/edit-->\n";
