...
sub pass {
	...
	if ($regname eq "" || $kana eq "" || $email eq "" || $add eq "" || $tel eq ""  || $shiharai eq "") {
		&error("ERROR","お名前、フリガナ、e-mail、ご住所、お電話番号、お支払方法は必須項目です。","BACK");
		exit;
	}
	...
	print "<TD>氏名 <span style=\"color:red;\"> *</span></TD>\n";
	print "<TD><input type=\"hidden\"name=\"regname\"VALUE=\"$regname\">$regname</TD>\n";
	print "</TR>\n";

	print "<TR BGCOLOR=\"$tab_color_main\" class=\"main\">\n";
	print "<TD>ふりがな <span style=\"color:red;\"> *</span></TD>\n";
	print "<TD><input type=\"hidden\"name=\"kana\"VALUE=\"$kana\">$kana</TD>\n";
	print "</TR>\n";
	
	print "<TR BGCOLOR=\"$tab_color_main\" class=\"main\">\n";
	print "<TD>E-mail <span style=\"color:red;\"> *</span></TD>\n";
	...
	print "<TR BGCOLOR=\"$tab_color_main\" class=\"main\">\n";
	print "<TD>住所 <span style=\"color:red;\"> *</span></TD>\n";
	print "<TD><input type=\"hidden\"name=\"add\"VALUE=\"$add\">$add</TD>\n";
	print "</TR>\n";
	
	print "<TR BGCOLOR=\"$tab_color_main\" class=\"main\">\n";
	print "<TD>TEL <span style=\"color:red;\"> *</span></TD>\n";
	...
	print "<TR BGCOLOR=\"$tab_color_main\" class=\"main\">\n";
	print "<TD>支払方法 <span style=\"color:red;\"> *</span></TD>\n";
