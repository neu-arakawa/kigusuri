...
$regname      = $MYDATA{'regname'};      $regname2    = $MYDATA{'regname2'};
...
#				print "<FONT COLOR=\"#000000\"><B>価格 $price_disp 円</B>＋税　</FONT> <FONT COLOR=\"#FF0000\"><B>在庫 $limit</B></FONT> <SELECT NAME=\"new_item\">";
				print "<FONT COLOR=\"#000000\">　</FONT> <FONT COLOR=\"#FF0000\"><B>在庫 $limit</B></FONT> <SELECT NAME=\"new_item\">";
...
#				print "<FONT COLOR=\"#000000\"><B>価格 $price_disp 円</B>＋税　</FONT> $selectgoods <INPUT TYPE=\"SUBMIT\"NAME=\"cart\"VALUE=\"カー\トに入れる\"> \n";
				print "<FONT COLOR=\"#000000\">　</FONT> $selectgoods <INPUT TYPE=\"SUBMIT\"NAME=\"cart\"VALUE=\"カー\トに入れる\"> \n";
				if($kbnMode == 1){ print "　<INPUT TYPE=\"SUBMIT\"NAME=\"cart\"VALUE=\"カテゴリ選択画面へ\">"; }
			}
...
#				print "<FONT COLOR=\"#000000\"><B>価格 $price_disp 円</B>＋税　</FONT> \n";
...
sub pass {
	...
	if ($regname eq "" || $email eq "" || $add eq "" || $tel eq ""  || $shiharai eq "") {
		&error("ERROR","お支払方法、お名前、e-mail、ご住所、お電話番号、支払い方法は必須項目です。","BACK");
		exit;
	}
...
sub errortop {
	...
	print "<BR>\n";
	print "<BR>\n";
#	print "<FORM><INPUT TYPE=\"button\" VALUE=\"$_[2]\" onClick=\"top.location.href='https://www.kigusuri.com/shop/$UserName/'\"></FORM>\n";
	&copy;
	exit;
}
