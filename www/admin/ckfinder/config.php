...
function CheckAuthentication()
{
    ...
    if(
         empty($_SESSION['admin']['logined']) and 
         ( empty($_SESSION['pharmacy']['member']['id']) or 
            $_SESSION['pharmacy']['member']['id'] != $_GET['pharmacy_id'] )
    ){
        return false;
    }
...
$config['LicenseName'] = 'neu.inc';
$config['LicenseKey'] = 'J6AD-STCE-5WTG-QFYV-LW5G-XVF8-JXRY';
...
else if(is_numeric($_GET['pharmacy_id'])){
    $baseUrl = '/files/shop/'.$_GET['pharmacy_id'].'/';
}
...
ATTENTION: The trailing slash is required.
*/
// if($_SERVER['HTTP_HOST'] ==='test1.itohkampo.co.jp'){
    // $baseDir = '/virtual/119.245.145.18/home/test1.itohkampo.co.jp/_files/ckf/';
// }else{
    $baseDir = resolveUrl($baseUrl);
// }
