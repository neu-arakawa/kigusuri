...
$Referer_check_domain = "kigusuri.com";
...
$require = array('お名前','メールアドレス','ご意見・ご感想');
...
$refrom_name = "きぐすりドットコム事務局";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "ご連絡ありがとうございました（漢方薬のきぐすり．com）";
...
この度はご意見・ご感想をお寄せいただき、誠にありがとうございました。
送信内容は以下になります。
...
＊このメールは、漢方情報サイト「漢方薬のきぐすり．com」の
　メールフォームよりご送信いただいた内容を自動的に送信しております。
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- □
　漢方相談薬局・薬店運営サイト　漢方薬のきぐすり.com
　http://www.kigusuri.com/　E-Mail：info@kigusuri.com
□ -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
